        ...
        <div className="h-[37.5rem] w-[100] flex">
            ...
            <div className="w-[50%] border bg-slate-800 text-center pt-40">
                ...
                <p className="pb-5  text-[20px]">share your excitment with us</p>
                 <div className="flex justify-center"><p className="text-[1.0625rem] font-semibold">info@ABZaaT@gmail.com </p><span className="mt-2 text-[17px]"><FaArrowRight/></span></div>
                <div className="flex justify-center">
                   <span className="mt-2 text-[18px]"><FaPhone/></span> <h1 className="text-[20px]">Contact Us: </h1>
